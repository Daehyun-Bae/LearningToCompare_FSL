...
def main():
    ...
    for episode in range(EPISODE):
        ...
        # sample datas
        samples, sample_labels = sample_dataloader.__iter__().next()  # 25*3*84*84 (support set Way*Shot)*3*H*W
        ...
        if episode % 5000 == 0:
            ...
            print("test accuracy:{:.3f}\th:{:.5f}\thighest: {:.3f}".format(test_accuracy, h, last_accuracy))
    ...
    print("Training end\nhighest test accuracy: {:.3f}\th:{:.3f}".format(last_accuracy, last_h))
